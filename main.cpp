...
int main()
{
	...
	Scenes::Object *p[] = {
			...
			new Triangle(Pos(-100, 0, 0), new Pos[3]{{0, -1000, 0}, {0, 0, 1000}, {0, 500, -1000}}, Color::WHITE, Emission::DARK, ElAg::NONROT, Object::DIFF),
	};

	renderer.setupStage(ObjectGroup(p, p + 5));

	renderer.setupCamera(Pos(500, 0, 0), ElAg(M_PI_2, -M_PI_2, 0));

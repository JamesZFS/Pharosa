...
#ifndef PHAROSA_LINEAR_CPP
#define PHAROSA_LINEAR_CPP
...
template bool Linear::Solve<3>(double (&A)[3][3], double (&b)[3], double (&x)[3]);    // ** instantiation
...
template bool Linear::SolveDebug<3>(double (&A)[3][3], double (&b)[3], double (&x)[3]);    // ** instantiation
...
template bool Linear::SolveInPlace<3>(double (&M)[3][4]);    // ** instantiation
